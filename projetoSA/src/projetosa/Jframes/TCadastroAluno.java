 ...
 * @author Kauan
 */
public class TCadastroAluno extends javax.swing.JFrame {

    /**
     * Creates new form TCadastroAluno
     */
    public TCadastroAluno() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TCadastroAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TCadastroAluno().setVisible(true);
            }
        });
    }
