...
public class ProfessorDao {
    ...
    public void inserir(projetosa.Professor professor) {
    ...
    public List<projetosa.Professor> listaProfessores() {
        List<projetosa.Professor> lista = new ArrayList();
        ...
        try (Connection conn = conexao.Conexao.getConexao(); PreparedStatement stm = conn.prepareStatement(sql); ResultSet rs = stm.executeQuery();) {
            while (rs.next()) {
                ...
                projetosa.Professor professor = new projetosa.Professor(nome, email, senha);
